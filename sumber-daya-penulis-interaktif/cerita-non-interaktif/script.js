...
// No longer relying on localStorage for theme, defaults to light-theme unless set manually.
...
saveApiKeyBtn.addEventListener('click', () => {
    ...
    if (key) {
        ...
        // Debugger is triggered here
        debugger;
        showMessageBox("Peringatan", "Kunci API tidak boleh kosong. Harap masukkan kunci yang valid.");
        // Stay on the API key screen
...
clearApiKeyBtn.addEventListener('click', () => {
    ...
    clearApiKey();
    apiKeyInput.value = '';
    showMessageBox("Info", "Kunci API telah dihapus. Silakan masukkan kunci baru.");
    showScreen('api-key-screen'); // Stay on API key screen
...
window.onload = () => {
    ...
    // Always show the API key screen on load
    showScreen('api-key-screen');
